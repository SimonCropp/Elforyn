...
Provides a wrapper around [PostgreSQL](https://www.postgresql.org/) to simplify running tests against [Entity Framework Core](https://docs.microsoft.com/en-us/ef/core/) using `CREATE DATABASE ... TEMPLATE` for fast per-test database isolation.<!-- singleLineInclude: intro. path: /docs/mdsource/intro.include.md -->
...
## Contents
  ...
  * [How this project works](#how-this-project-works)
    * [Inputs](#inputs)
    * [PgInstance Startup Flow](#pginstance-startup-flow)
    * [Create PgDatabase Flow](#create-pgdatabase-flow)
  * [Debugging](#debugging)<!-- endToc -->
