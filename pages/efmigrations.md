...
```
<sup><a href='/src/Elforyn.Tests/Snippets/Migrations.cs#L7-L28' title='Snippet source file'>snippet source</a> | <a href='#snippet-Migrations' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
options.ReplaceService<IMigrationsSqlGenerator, MigrationsGenerator>();
```
<sup><a href='/src/Elforyn.Tests/Snippets/Migrations.cs#L13-L17' title='Snippet source file'>snippet source</a> | <a href='#snippet-IMigrationsSqlGenerator' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
await data.Database.MigrateAsync();
```
<sup><a href='/src/Elforyn.Tests/Snippets/Migrations.cs#L19-L24' title='Snippet source file'>snippet source</a> | <a href='#snippet-Migrate' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
